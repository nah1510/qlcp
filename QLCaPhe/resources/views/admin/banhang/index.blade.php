...
<body class="style-1">
    ...
    <section class="content wrapper">
        ...
        <div class="content-rightside">
            ...
            <div class="wrapSum">
                <div class="Sum">
                    <div class="Sum-item"><input type="text" id="total_bill" class="form-controll form-controll-sum "
                            name="total_bill" value="0" readonly><img src='/upload/icon/coins.svg' alt='icon'
                            class="moneyIcon"></div>
                </div>
