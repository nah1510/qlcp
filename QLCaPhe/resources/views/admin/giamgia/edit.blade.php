                ...
                <form action="edit?id={{$giamgia->id}}" method="POST" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="type">
                            <option {{ $giamgia->type == '1' ? 'selected' : '' }} value="1">Khấu trừ theo phần trăm hóa
                                đơn</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Số tiền giảm giá hoặc phần trăm giảm giá"
                            name="discount" value="{{$giamgia->discount}}" min="1" required>
                    </div>
                    <div class="form-group">
                        <label for="">Tổng hóa đơn tối thiểu:</label>
                        <input type="number" class="form-control" placeholder="Tổng hóa đơn tối thiểu" name="min_bill"
                            value="{{$giamgia->min_bill}}">
                    </div>
                    <div class="form-group">
